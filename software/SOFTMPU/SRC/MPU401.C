...
void MPU401_Init(void far* qpientry,Bitu mcellport,Bitu sbport,Bitu irq,Bitu mpuport,Bitu serialport,OutputMode outputmode,bool delaysysex,bool fakeallnotesoff)
{
	...
	/* Initialise MIDI handler */
        MIDI_Init(mpuport,mcellport,sbport,serialport,outputmode,delaysysex,fakeallnotesoff);
